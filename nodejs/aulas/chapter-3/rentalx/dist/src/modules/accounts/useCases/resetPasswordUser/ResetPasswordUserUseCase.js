...
var ResetPasswordUserUseCase = /** @class */ (function () {
    function ResetPasswordUserUseCase(usersTokensRepository, dateProvider, usersRepository) {
        this.usersTokensRepository = usersTokensRepository;
        this.dateProvider = dateProvider;
        this.usersRepository = usersRepository;
    }
    ResetPasswordUserUseCase.prototype.execute = function (_a) {
        var token = _a.token, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var userToken, user, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.usersTokensRepository.findByRefreshToken(token)];
                    case 1:
                        userToken = _c.sent();
                        if (!userToken) {
