...
var SpecificationsRepository = /** @class */ (function () {
    function SpecificationsRepository() {
        this.repository = typeorm_1.getRepository(Specification_1.Specification);
    }
    SpecificationsRepository.prototype.create = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        specification = this.repository.create({
                            description: description,
                            name: name,
                        });
                        return [4 /*yield*/, this.repository.save(specification)];
                    case 1:
                        _b.sent();
                        return [2 /*return*/, specification];
                }
            });
        });
    };
    ...
    SpecificationsRepository.prototype.findByIds = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            var specifications;
            return __generator(this, function (_a) {
                switch (_a.label) {
