...
var CreateSpecificationUseCase = /** @class */ (function () {
    ...
    CreateSpecificationUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var specificationAlreadyExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.specificationsRepository.findByName(name)];
                    case 1:
                        specificationAlreadyExists = _b.sent();
    ...
    CreateSpecificationUseCase = __decorate([
        ...
        __param(0, tsyringe_1.inject("SpecificationsRepository")),
