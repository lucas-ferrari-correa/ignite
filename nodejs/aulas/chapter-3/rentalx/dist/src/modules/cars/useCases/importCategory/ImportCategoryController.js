...
var ImportCategoryController = /** @class */ (function () {
    ...
    ImportCategoryController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var file, importCategoryUseCase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        file = request.file;
                        importCategoryUseCase = tsyringe_1.container.resolve(ImportCategoryUseCase_1.ImportCategoryUseCase);
                        return [4 /*yield*/, importCategoryUseCase.execute(file)];
                    case 1:
                        _a.sent();
