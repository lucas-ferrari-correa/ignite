...
var CreateSpecificationController = /** @class */ (function () {
    ...
    CreateSpecificationController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, createSpecificationUseCase;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, description = _a.description;
                        createSpecificationUseCase = tsyringe_1.container.resolve(CreateSpecificationUseCase_1.CreateSpecificationUseCase);
                        return [4 /*yield*/, createSpecificationUseCase.execute({
                                name: name,
