...
var CarsRepositoryInMemory = /** @class */ (function () {
    ...
    CarsRepositoryInMemory.prototype.create = function (_a) {
        var brand = _a.brand, category_id = _a.category_id, daily_rate = _a.daily_rate, description = _a.description, fine_amount = _a.fine_amount, name = _a.name, license_plate = _a.license_plate, id = _a.id;
    ...
    CarsRepositoryInMemory.prototype.findAvailable = function (brand, category_id, name) {
        return __awaiter(this, void 0, void 0, function () {
            var cars;
            return __generator(this, function (_a) {
    ...
    CarsRepositoryInMemory.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.cars.find(function (car) { return car.id === id; })];
            });
        });
    };
    CarsRepositoryInMemory.prototype.updateAvailable = function (id, available) {
        return __awaiter(this, void 0, void 0, function () {
            var findIndex;
            return __generator(this, function (_a) {
                findIndex = this.cars.findIndex(function (car) { return car.id === id; });
