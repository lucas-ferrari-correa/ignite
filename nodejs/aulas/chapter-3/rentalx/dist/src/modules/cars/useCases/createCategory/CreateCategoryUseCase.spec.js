...
var CategoriesRepositoryInMemory_1 = require("@modules/cars/repositories/in-memory/CategoriesRepositoryInMemory");
...
describe("Create Category", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, createCategoryUseCase.execute(__assign({}, category))];
                case 1:
                    _a.sent();
    ...
    it("should not be able to create an existing category", function () { return __awaiter(void 0, void 0, void 0, function () {
        var category;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expect(createCategoryUseCase.execute(__assign({}, category))).rejects.toEqual(new AppError_1.AppError("Category already exists"))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
