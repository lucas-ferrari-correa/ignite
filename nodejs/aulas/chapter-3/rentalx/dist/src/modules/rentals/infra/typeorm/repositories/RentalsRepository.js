...
var RentalsRepository = /** @class */ (function () {
    ...
    RentalsRepository.prototype.findOpenRentalByCar = function (car_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                openByCar = this.repository.findOne({
    ...
    RentalsRepository.prototype.findOpenRentalByUser = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var openByUser;
            return __generator(this, function (_a) {
                openByUser = this.repository.findOne({
    ...
    RentalsRepository.prototype.create = function (_a) {
        var car_id = _a.car_id, user_id = _a.user_id, expected_return_date = _a.expected_return_date, id = _a.id, end_date = _a.end_date, total = _a.total;
        return __awaiter(this, void 0, void 0, function () {
            var rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repository.save(rental)];
                    case 1:
                        _b.sent();
