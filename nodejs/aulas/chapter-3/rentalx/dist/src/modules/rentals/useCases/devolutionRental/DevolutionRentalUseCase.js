...
var DevolutionRentalUseCase = /** @class */ (function () {
    function DevolutionRentalUseCase(rentalsRepository, carsRepository, dateProvider) {
    ...
    DevolutionRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var rental, car, minimum_daily, dateNow, daily, delay, total, calculate_fine;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.rentalsRepository.findById(id)];
                    case 1:
                        rental = _b.sent();
                        return [4 /*yield*/, this.carsRepository.findById(rental.car_id)];
                    case 2:
                        car = _b.sent();
                        minimum_daily = 1;
                        if (!rental) {
                            throw new AppError_1.AppError("Rental does not exist!");
                        }
                    ...
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, this.carsRepository.updateAvailable(car.id, true)];
                    case 4:
                        _b.sent();
    ...
    DevolutionRentalUseCase = __decorate([
        ...
        __param(1, tsyringe_1.inject("CarsRepository")),
