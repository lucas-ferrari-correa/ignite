...
function ensureAuthenticated(request, response, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, usersTokensRepository, _a, token, userId;
        return __generator(this, function (_b) {
            authHeader = request.headers.authorization;
            usersTokensRepository = new UsersTokensRepository_1.UsersTokensRepository();
            if (!authHeader) {
                throw new AppError_1.AppError("Token missing", 401);
            }
            _a = authHeader.split(" "), token = _a[1];
            try {
                userId = jsonwebtoken_1.verify(token, auth_1.default.secret_token).sub;
                request.user = {
                    id: userId,
                };
                next();
