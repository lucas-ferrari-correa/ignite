...
var LocalStorageProvider = /** @class */ (function () {
    ...
    LocalStorageProvider.prototype.save = function (file, folder) {
    ...
    LocalStorageProvider.prototype.delete = function (file, folder) {
        return __awaiter(this, void 0, void 0, function () {
            var filename, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        filename = path_1.resolve(upload_1.default.tmpFolder + "/" + folder, file);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
