...
var SESMailProvider = /** @class */ (function () {
    ...
    SESMailProvider.prototype.sendMail = function (to, subject, variables, path) {
        return __awaiter(this, void 0, void 0, function () {
            var templateFileContent, templateParse, templateHTML;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.sendMail({
                                to: to,
                                from: "Rentalx <lucas@ferraricorrea.com>",
                                subject: subject,
                                html: templateHTML,
                            })];
                    case 1:
